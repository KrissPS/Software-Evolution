...
public class CaseInsensitiveTest {
        ...
        void compareParseTrees() throws Exception {
                ...
                String normal = BabyCobolParserUtils.readResource(
                                "/examples/normal.babycob");

                String insensitive = BabyCobolParserUtils.readResource(
                                "/examples/insensitive.babycob");

                String normalTree = BabyCobolParserUtils.parseTree(normal);

                String insensitiveTree = BabyCobolParserUtils.parseTree(
